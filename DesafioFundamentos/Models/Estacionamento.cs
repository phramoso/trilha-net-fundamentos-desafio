    ...
    public class Estacionamento
    {
        ...
        public void AdicionarVeiculo()
        {
            ...
            string placa = Console.ReadLine();
             ...
             // Confirmar ao usuário que a placa foi adicionada com sucesso
        ...
        public void RemoverVeiculo()
        {
            ...
            if (veiculos.Any(x => x.ToUpper() == placa.ToUpper()))
            {
                ...
                // Exibir o valor total para o usuário
                Console.WriteLine("O valor total a ser pago é: " + valorTotal.ToString("C"));
        ...
        public void ListarVeiculos()
        {
            ...
            if (veiculos.Any())
            {
                ...
                // Loop através da lista de veículos e exibir cada placa
